...
export const DATA_SOURCE_REGISTRY: DataSourceDef[] = [
  ...
  { code: "DUKCAPIL", sourceName: "Dukcapil GIS Kemendagri (registrasi penduduk)", sourceUrl: "https://gis.dukcapil.kemendagri.go.id", sourceType: "official_website", scopeType: "national", scopeName: "Indonesia", trustLevel: 5, format: "API_JSON", frekuensiUpdate: "semesteran" },
